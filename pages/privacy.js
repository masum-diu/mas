      ...
      <Layout>
        ...
        <Grid item lg={12}>
            <Stack alignItems={"center"} justifyContent={"center"} direction={"column"} sx={{ position: "relative", top:"10px" }}>
               ...
               <Typography className="Regular" fontSize={16} color={"#bbb"} sx={{ display: "flex", flexDirection: "column", }}>Company: when this policy mentions “Company,” “we,” “us,” or “our,” it refers to Aranya, (House 1/A, Road 21 Nikunja 2, Khilkhet Dhaka 1229, Bangladesh), that is responsible for your information under this Privacy Policy.</Typography>
               <Typography className="Regular" fontSize={16} color={"#bbb"} sx={{ display: "flex", flexDirection: "column", }}>Country: where Aranya or the owners/founders of Aranya are based, in this case is Bangladesh</Typography>
               <Typography className="Regular" fontSize={16} color={"#bbb"} sx={{ display: "flex", flexDirection: "column", }}>Customer: refers to the company, organization or person that signs up to use the Aranya Service to manage the relationships with your consumers or service users.</Typography>
               <Typography className="Regular" fontSize={16} color={"#bbb"} sx={{ display: "flex", flexDirection: "column", }}>Device: any internet connected device such as a phone, tablet, computer or any other device that can be used to visit Aranya and use the services.</Typography>
               ...
               <Typography className="Regular" fontSize={16} color={"#bbb"} sx={{ display: "flex", flexDirection: "column", }}>Personnel: refers to those individuals who are employed by Aranya or are under contract to perform a service on behalf of one of the parties.</Typography>
               ...
               <Typography className="Regular" fontSize={16} color={"#bbb"} sx={{ display: "flex", flexDirection: "column", }}>You: a person or entity that is registered with Aranya to use the Services.</Typography>
               <Typography className="Regular" fontSize={16} color={"#bbb"} sx={{ display: "flex", flexDirection: "column", }}>Personnel: refers to those individuals who are employed by Aranya or are under contract to perform a service on behalf of one of the parties.</Typography>
               <Typography className="Regular" fontSize={16} color={"#bbb"} sx={{ display: "flex", flexDirection: "column", }}>Third-party service: refers to advertisers, contest sponsors, promotional and marketing partners, and others who provide our content or whose products or services we think may interest you.</Typography>
               <Typography className="Regular" fontSize={16} color={"#bbb"} sx={{ display: "flex", flexDirection: "column", }}>You: a person or entity that is registered with Aranya to use the Services.</Typography>
